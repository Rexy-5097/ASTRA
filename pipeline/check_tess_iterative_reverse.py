...
target_classes = ["solar_like"] # Only check solar_like
needed_successful = {"solar_like": 250}
successful_found = {"solar_like": 0}
...
for idx in reversed(df.index):
    ...
    print(f"Checking reverse {cls} row {idx}...", end="", flush=True)
    res = check_tess(row)
